...
public class WfMcGameManager : MonoBehaviour
{
    public WfMcQuestions[] question;
    private WfMcQuestions currenQuestion;
    private static List<WfMcQuestions> unansweredQuestions;
    ...
    void Start()
    {
        ...
        {
            unansweredQuestions = question.ToList<WfMcQuestions>();
        }
