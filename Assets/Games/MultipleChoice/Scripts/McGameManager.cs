...
{
    public McQuestions[] question;
    private McQuestions currenQuestion;
    private static List<McQuestions> unansweredQuestions;
    ...
    void Start()
    {
        ...
        {
            unansweredQuestions = question.ToList<McQuestions>();
        }
